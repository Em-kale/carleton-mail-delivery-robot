...
class PlotNavigationNodeTest(Node):
    ...
    def __init__(self):
        ...
        # Create subscriber, msg_type = String, topic = "bumper", callback = self.callback
        self.navigator_subscriber = self.create_subscription(String, 'navigator', self.callback, 10)
